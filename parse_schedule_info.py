...
from filter_summary_infotype import file_reader, file_reader_json
from filter_summary_infotype import get_openai_response_binary, get_openai_response_structured
...
def parse_Movecourse(client, prompt):
    ...
    return move_courses_constraints
